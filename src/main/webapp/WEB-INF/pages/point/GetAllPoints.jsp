...
<div >
	...
	<input type="text" class="search" name="search" id="search" placeholder="搜尋會員編號、姓名及手機等資訊" value="${keyWord != null ? keyWord : ''}" }>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" id="doSearch"><i class="fa-solid fa-magnifying-glass"></i></button>
	<p class="notice"></p>	
	</form>
</div>
<br>
...
<% List<PointMemberDTO> pointMembers=(ArrayList<PointMemberDTO>)request.getAttribute("pointMembers");
	...
	<td><form action="/EEIT187-6/Point/SetPointMemberIndex" method="get" style="margin: 0;">
